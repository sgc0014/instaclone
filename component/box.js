...
function Box() {
    return (
        ...
        <div className={styles.formContainer}>
          <h1 className={styles.instaHeader}>   <img className={styles.instagram} src="/static/instagram.png" alt='' /></h1>
          ...
          <button className={styles.facebook}>
            <span className={styles.fbLogo} ><AiFillFacebook size='1.5em' /></span>
